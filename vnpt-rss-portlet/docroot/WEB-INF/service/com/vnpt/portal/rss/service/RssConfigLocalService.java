...
/**
 * Provides the local service interface for RssConfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MrNet
 * @see RssConfigLocalServiceUtil
...
public interface RssConfigLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RssConfigLocalServiceUtil} to access the rss config local service. Add custom service methods to {@link com.vnpt.portal.rss.service.impl.RssConfigLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
