...
package com.vnpt.portal.rss.utils;
...
public class RSSWebCacheItem implements WebCacheItem {
	...
	public Object convert(String key) throws WebCacheException {
		...
		try {
			...
			System.out.println("RssWebCache url : "+ _url);
...
//				PropsValues.RSS_CONNECTION_TIMEOUT);
					GetterUtil.getInteger(PropsUtil.get(PropsKeys.RSS_CONNECTION_TIMEOUT)));
//			httpClientParams.setSoTimeout(PropsValues.RSS_CONNECTION_TIMEOUT);
			httpClientParams.setSoTimeout(GetterUtil.getInteger(PropsUtil.get(PropsKeys.RSS_CONNECTION_TIMEOUT)));
			...
			System.out.println("RssWebCache exception :"+e.getMessage());
...
//		return Time.MINUTE * PropsValues.RSS_FEED_REFRESH_TIME;
		return Time.MINUTE * GetterUtil.getLong(PropsUtil.get(PropsKeys.RSS_FEED_REFRESH_TIME));
	}
