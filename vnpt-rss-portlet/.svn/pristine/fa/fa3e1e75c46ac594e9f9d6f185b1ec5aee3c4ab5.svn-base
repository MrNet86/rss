...
import com.vnpt.portal.rss.service.RssCategoryLocalService;
...
/**
 * Provides the base implementation for the rss category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vnpt.portal.rss.service.impl.RssCategoryLocalServiceImpl}.
 * </p>
 *
 * @author MrNet
 ...
 * @generated
 */
public abstract class RssCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RssCategoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vnpt.portal.rss.service.RssCategoryLocalServiceUtil} to access the rss category local service.
	 */
	...
	@Override
	public RssCategory addRssCategory(RssCategory rssCategory)
		throws SystemException {
		rssCategory.setNew(true);

		return rssCategoryPersistence.update(rssCategory);
	}
	 ...
	 */
	@Override
	public RssCategory createRssCategory(long rssCategoryId) {
		return rssCategoryPersistence.create(rssCategoryId);
	}
	...
	@Override
	public RssCategory deleteRssCategory(long rssCategoryId)
		throws PortalException, SystemException {
		return rssCategoryPersistence.remove(rssCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public RssCategory deleteRssCategory(RssCategory rssCategory)
		throws SystemException {
		return rssCategoryPersistence.remove(rssCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RssCategory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return rssCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return rssCategoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return rssCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public RssCategory fetchRssCategory(long rssCategoryId)
		throws SystemException {
		return rssCategoryPersistence.fetchByPrimaryKey(rssCategoryId);
	}
	...
	public RssCategory getRssCategory(long rssCategoryId)
		throws PortalException, SystemException {
		return rssCategoryPersistence.findByPrimaryKey(rssCategoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return rssCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RssCategory> getRssCategories(int start, int end)
		throws SystemException {
		return rssCategoryPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getRssCategoriesCount() throws SystemException {
		return rssCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RssCategory updateRssCategory(RssCategory rssCategory)
		throws SystemException {
		return rssCategoryPersistence.update(rssCategory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vnpt.portal.rss.model.RssCategory",
			rssCategoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = rssCategoryPersistence.getDataSource();
	...
	private RssCategoryLocalServiceClpInvoker _clpInvoker = new RssCategoryLocalServiceClpInvoker();
}