...
/**
 * Provides the local service interface for RssFeeds. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MrNet
 * @see RssFeedsLocalServiceUtil
...
public interface RssFeedsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RssFeedsLocalServiceUtil} to access the rss feeds local service. Add custom service methods to {@link com.vnpt.portal.rss.service.impl.RssFeedsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
