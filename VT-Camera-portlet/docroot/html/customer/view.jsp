...
<aui:form action="" method="post" name="fm">
	...
	<aui:row>
		<aui:col span="4">
			<aui:select name="customerGroup" label="Nhóm loại khách hàng" onChange="getCustomerTypeByGroup()">
	        ...
	        A.io.request('<%=  getCustomerTypeByGroupURL %>', {
	               ...
	               on: {
	            	   success: function(event, id, obj) {
	                	   ...
	                	   console.log("get type service success :"+ responseData.typeTitle);
	                	   ...
	                	   opt.innerHTML = responseData.typeTitle;
	                	   opt.value = responseData.titleId;
