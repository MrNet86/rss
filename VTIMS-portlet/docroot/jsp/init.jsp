...
<!-- IMS Portlet -->
<%@ page import="com.viettel.ims.common.*"%>
<%@ page import="com.viettel.ims.controller.*"%>
<%@ page import="com.viettel.ims.core.model.impl.*"%>
<%@ page import="com.viettel.ims.core.service.base.*"%>
<%@ page import="com.viettel.ims.core.service.http.*"%>
<%@ page import="com.viettel.ims.core.service.impl.*"%>
<%@ page import="com.viettel.ims.core.service.persistence.*"%>
...
<%
	...
	String navigateMenu = "/jsp/navMenu.jsp";
