...
/**
 * Provides the local service interface for InvestPolicyExt. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MrNet
 * @see InvestPolicyExtLocalServiceUtil
...
public interface InvestPolicyExtLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InvestPolicyExtLocalServiceUtil} to access the invest policy ext local service. Add custom service methods to {@link com.viettel.ims.core.service.impl.InvestPolicyExtLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
