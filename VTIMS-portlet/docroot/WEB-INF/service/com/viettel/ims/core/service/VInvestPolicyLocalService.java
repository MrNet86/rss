...
/**
 * Provides the local service interface for VInvestPolicy. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MrNet
 * @see VInvestPolicyLocalServiceUtil
...
public interface VInvestPolicyLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VInvestPolicyLocalServiceUtil} to access the v invest policy local service. Add custom service methods to {@link com.viettel.ims.core.service.impl.VInvestPolicyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
