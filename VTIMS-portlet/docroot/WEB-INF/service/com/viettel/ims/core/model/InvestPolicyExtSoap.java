 ...
 * @generated
 */
public class InvestPolicyExtSoap implements Serializable {
	public static InvestPolicyExtSoap toSoapModel(InvestPolicyExt model) {
		InvestPolicyExtSoap soapModel = new InvestPolicyExtSoap();
		...
		soapModel.setInfoResponsibleUserName(model.getInfoResponsibleUserName());
		soapModel.setInfoInvestCreateGroupName(model.getInfoInvestCreateGroupName());
		soapModel.setInfoInvestDeployGroupName(model.getInfoInvestDeployGroupName());

		return soapModel;
	}

	public static InvestPolicyExtSoap[] toSoapModels(InvestPolicyExt[] models) {
		InvestPolicyExtSoap[] soapModels = new InvestPolicyExtSoap[models.length];
	...
	public static InvestPolicyExtSoap[][] toSoapModels(
		InvestPolicyExt[][] models) {
		InvestPolicyExtSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new InvestPolicyExtSoap[models.length][models[0].length];
		}
		else {
			soapModels = new InvestPolicyExtSoap[0][0];
		}
	...
	public static InvestPolicyExtSoap[] toSoapModels(
		List<InvestPolicyExt> models) {
		List<InvestPolicyExtSoap> soapModels = new ArrayList<InvestPolicyExtSoap>(models.size());

		for (InvestPolicyExt model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new InvestPolicyExtSoap[soapModels.size()]);
	}

	public InvestPolicyExtSoap() {
	}
