...
package com.viettel.ims.core.service.messaging;
...
import com.viettel.ims.core.service.FileAttachmentServiceUtil;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			InvestCategoriesLocalServiceUtil.clearService();

			InvestPolicyLocalServiceUtil.clearService();

			InvestPolicyExtLocalServiceUtil.clearService();

			SysGroupLocalServiceUtil.clearService();

			VInvestPolicyLocalServiceUtil.clearService();
		}
	}
}