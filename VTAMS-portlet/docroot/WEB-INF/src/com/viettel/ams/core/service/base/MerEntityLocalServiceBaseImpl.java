...
import com.viettel.ams.core.service.MerEntityLocalService;
...
/**
 * Provides the base implementation for the mer entity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viettel.ams.core.service.impl.MerEntityLocalServiceImpl}.
 * </p>
 *
 * @author MrNet
 ...
 * @generated
 */
public abstract class MerEntityLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MerEntityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viettel.ams.core.service.MerEntityLocalServiceUtil} to access the mer entity local service.
	 */
	...
	@Override
	public MerEntity addMerEntity(MerEntity merEntity)
		throws SystemException {
		merEntity.setNew(true);

		return merEntityPersistence.update(merEntity);
	}
	 ...
	 */
	@Override
	public MerEntity createMerEntity(long merEntityId) {
		return merEntityPersistence.create(merEntityId);
	}
	...
	@Override
	public MerEntity deleteMerEntity(long merEntityId)
		throws PortalException, SystemException {
		return merEntityPersistence.remove(merEntityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MerEntity deleteMerEntity(MerEntity merEntity)
		throws SystemException {
		return merEntityPersistence.remove(merEntity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MerEntity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return merEntityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return merEntityPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return merEntityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MerEntity fetchMerEntity(long merEntityId) throws SystemException {
		return merEntityPersistence.fetchByPrimaryKey(merEntityId);
	}
	 ...
	 */
	@Override
	public MerEntity getMerEntity(long merEntityId)
		throws PortalException, SystemException {
		return merEntityPersistence.findByPrimaryKey(merEntityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return merEntityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MerEntity> getMerEntities(int start, int end)
		throws SystemException {
		return merEntityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMerEntitiesCount() throws SystemException {
		return merEntityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MerEntity updateMerEntity(MerEntity merEntity)
		throws SystemException {
		return merEntityPersistence.update(merEntity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viettel.ams.core.model.MerEntity",
			merEntityLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = merEntityPersistence.getDataSource();
	...
	private MerEntityLocalServiceClpInvoker _clpInvoker = new MerEntityLocalServiceClpInvoker();
}