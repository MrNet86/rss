...
import com.viettel.ams.core.service.AssetManageReqHandleLocalService;
...
/**
 * Provides the base implementation for the asset manage req handle local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viettel.ams.core.service.impl.AssetManageReqHandleLocalServiceImpl}.
 * </p>
 *
 * @author MrNet
 ...
 * @generated
 */
public abstract class AssetManageReqHandleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetManageReqHandleLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viettel.ams.core.service.AssetManageReqHandleLocalServiceUtil} to access the asset manage req handle local service.
	 */
	...
	@Override
	public AssetManageReqHandle addAssetManageReqHandle(
		AssetManageReqHandle assetManageReqHandle) throws SystemException {
		assetManageReqHandle.setNew(true);

		return assetManageReqHandlePersistence.update(assetManageReqHandle);
	}
	 ...
	 */
	@Override
	public AssetManageReqHandle createAssetManageReqHandle(long handleId) {
		return assetManageReqHandlePersistence.create(handleId);
	}
	...
	@Override
	public AssetManageReqHandle deleteAssetManageReqHandle(long handleId)
		throws PortalException, SystemException {
		return assetManageReqHandlePersistence.remove(handleId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AssetManageReqHandle deleteAssetManageReqHandle(
		AssetManageReqHandle assetManageReqHandle) throws SystemException {
		return assetManageReqHandlePersistence.remove(assetManageReqHandle);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssetManageReqHandle.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return assetManageReqHandlePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetManageReqHandlePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssetManageReqHandle fetchAssetManageReqHandle(long handleId)
		throws SystemException {
		return assetManageReqHandlePersistence.fetchByPrimaryKey(handleId);
	}
	 ...
	 */
	@Override
	public AssetManageReqHandle getAssetManageReqHandle(long handleId)
		throws PortalException, SystemException {
		return assetManageReqHandlePersistence.findByPrimaryKey(handleId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetManageReqHandlePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssetManageReqHandle> getAssetManageReqHandles(int start,
		int end) throws SystemException {
		return assetManageReqHandlePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssetManageReqHandlesCount() throws SystemException {
		return assetManageReqHandlePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssetManageReqHandle updateAssetManageReqHandle(
		AssetManageReqHandle assetManageReqHandle) throws SystemException {
		return assetManageReqHandlePersistence.update(assetManageReqHandle);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viettel.ams.core.model.AssetManageReqHandle",
			assetManageReqHandleLocalService);
	}
	...
	private AssetManageReqHandleLocalServiceClpInvoker _clpInvoker = new AssetManageReqHandleLocalServiceClpInvoker();
}