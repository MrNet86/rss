...
import com.viettel.ams.core.service.AssetManageReqLocalService;
...
/**
 * Provides the base implementation for the asset manage req local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.viettel.ams.core.service.impl.AssetManageReqLocalServiceImpl}.
 * </p>
 *
 * @author MrNet
 ...
 * @generated
 */
public abstract class AssetManageReqLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetManageReqLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.viettel.ams.core.service.AssetManageReqLocalServiceUtil} to access the asset manage req local service.
	 */
	...
	@Override
	public AssetManageReq addAssetManageReq(AssetManageReq assetManageReq)
		throws SystemException {
		assetManageReq.setNew(true);

		return assetManageReqPersistence.update(assetManageReq);
	}
	 ...
	 */
	@Override
	public AssetManageReq createAssetManageReq(long manageReqId) {
		return assetManageReqPersistence.create(manageReqId);
	}
	...
	@Override
	public AssetManageReq deleteAssetManageReq(long manageReqId)
		throws PortalException, SystemException {
		return assetManageReqPersistence.remove(manageReqId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AssetManageReq deleteAssetManageReq(AssetManageReq assetManageReq)
		throws SystemException {
		return assetManageReqPersistence.remove(assetManageReq);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssetManageReq.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetManageReqPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assetManageReqPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public AssetManageReq fetchAssetManageReq(long manageReqId)
		throws SystemException {
		return assetManageReqPersistence.fetchByPrimaryKey(manageReqId);
	}
	 ...
	 */
	@Override
	public AssetManageReq getAssetManageReq(long manageReqId)
		throws PortalException, SystemException {
		return assetManageReqPersistence.findByPrimaryKey(manageReqId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return assetManageReqPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssetManageReq> getAssetManageReqs(int start, int end)
		throws SystemException {
		return assetManageReqPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAssetManageReqsCount() throws SystemException {
		return assetManageReqPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssetManageReq updateAssetManageReq(AssetManageReq assetManageReq)
		throws SystemException {
		return assetManageReqPersistence.update(assetManageReq);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.viettel.ams.core.model.AssetManageReq",
			assetManageReqLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assetManageReqPersistence.getDataSource();
	...
	private AssetManageReqLocalServiceClpInvoker _clpInvoker = new AssetManageReqLocalServiceClpInvoker();
}