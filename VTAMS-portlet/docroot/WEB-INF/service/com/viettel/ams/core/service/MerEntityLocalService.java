...
/**
 * Provides the local service interface for MerEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MrNet
 * @see MerEntityLocalServiceUtil
...
public interface MerEntityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MerEntityLocalServiceUtil} to access the mer entity local service. Add custom service methods to {@link com.viettel.ams.core.service.impl.MerEntityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
