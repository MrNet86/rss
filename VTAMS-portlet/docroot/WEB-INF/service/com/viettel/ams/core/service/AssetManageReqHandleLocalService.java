...
/**
 * Provides the local service interface for AssetManageReqHandle. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MrNet
 * @see AssetManageReqHandleLocalServiceUtil
...
public interface AssetManageReqHandleLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssetManageReqHandleLocalServiceUtil} to access the asset manage req handle local service. Add custom service methods to {@link com.viettel.ams.core.service.impl.AssetManageReqHandleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
