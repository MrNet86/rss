...
/**
 * The persistence utility for the asset manage req handle entity service. This utility wraps {@link AssetManageReqHandleEntityPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class AssetManageReqHandleEntityUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(assetManageReqHandleEntity);
	}
	 ...
	 */
	public static List<AssetManageReqHandleEntity> findWithDynamicQuery(
	 ...
	 */
	public static AssetManageReqHandleEntity update(
		AssetManageReqHandleEntity assetManageReqHandleEntity)
		throws SystemException {
		return getPersistence().update(assetManageReqHandleEntity);
	}
	...
	public static AssetManageReqHandleEntity update(
		...
		return getPersistence()
				   .update(assetManageReqHandleEntity, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(assetManageReqHandleEntity);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(assetManageReqHandleEntities);
	}
	...
	*/
	public static com.viettel.ams.core.model.AssetManageReqHandleEntity create(
		long id) {
	...
	*/
	public static com.viettel.ams.core.model.AssetManageReqHandleEntity remove(
		long id)
	...
	public static com.viettel.ams.core.model.AssetManageReqHandleEntity updateImpl(
		com.viettel.ams.core.model.AssetManageReqHandleEntity assetManageReqHandleEntity)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(assetManageReqHandleEntity);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.viettel.ams.core.model.AssetManageReqHandleEntity findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.viettel.ams.core.NoSuchAssetManageReqHandleEntityException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.viettel.ams.core.model.AssetManageReqHandleEntity fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.viettel.ams.core.model.AssetManageReqHandleEntity> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static AssetManageReqHandleEntityPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (AssetManageReqHandleEntityPersistence)PortletBeanLocatorUtil.locate(com.viettel.ams.core.service.ClpSerializer.getServletContextName(),
					AssetManageReqHandleEntityPersistence.class.getName());

			ReferenceRegistry.registerReference(AssetManageReqHandleEntityUtil.class,
				"_persistence");
		}
	...
	public void setPersistence(
		AssetManageReqHandleEntityPersistence persistence) {
	}

	private static AssetManageReqHandleEntityPersistence _persistence;
}