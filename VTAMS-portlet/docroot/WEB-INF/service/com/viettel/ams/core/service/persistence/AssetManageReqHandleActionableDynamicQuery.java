 ...
 * @generated
 */
public abstract class AssetManageReqHandleActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public AssetManageReqHandleActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(AssetManageReqHandleLocalServiceUtil.getService());
		setClass(AssetManageReqHandle.class);

		setClassLoader(com.viettel.ams.core.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("handleId");
	}
}