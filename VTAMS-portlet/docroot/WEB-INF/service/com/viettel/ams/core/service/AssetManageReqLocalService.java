...
/**
 * Provides the local service interface for AssetManageReq. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MrNet
 * @see AssetManageReqLocalServiceUtil
...
public interface AssetManageReqLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssetManageReqLocalServiceUtil} to access the asset manage req local service. Add custom service methods to {@link com.viettel.ams.core.service.impl.AssetManageReqLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
