...
public class PermissionGroupPersistenceImpl extends BasePersistenceImpl<PermissionGroup>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ROLEID = new FinderPath(PermissionGroupModelImpl.ENTITY_CACHE_ENABLED,
			PermissionGroupModelImpl.FINDER_CACHE_ENABLED,
			PermissionGroupImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByRoleId",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ROLEID =
		new FinderPath(PermissionGroupModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			PermissionGroupModelImpl.ROLEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ROLEID = new FinderPath(PermissionGroupModelImpl.ENTITY_CACHE_ENABLED,
			PermissionGroupModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<PermissionGroup> findByRoleId(long roleId)
		throws SystemException {
	 ...
	 */
	@Override
	public List<PermissionGroup> findByRoleId(long roleId, int start, int end)
		throws SystemException {
	...
	public List<PermissionGroup> findByRoleId(long roleId, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (PermissionGroup permissionGroup : list) {
				if ((roleId != permissionGroup.getRoleId())) {
					list = null;
	 ...
	 */
	@Override
	public PermissionGroup findByRoleId_First(long roleId,
		OrderByComparator orderByComparator)
		throws NoSuchPermissionGroupException, SystemException {
		PermissionGroup permissionGroup = fetchByRoleId_First(roleId,
				orderByComparator);
	 ...
	 */
	@Override
	public PermissionGroup fetchByRoleId_First(long roleId,
		OrderByComparator orderByComparator) throws SystemException {
		List<PermissionGroup> list = findByRoleId(roleId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public PermissionGroup findByRoleId_Last(long roleId,
		OrderByComparator orderByComparator)
		throws NoSuchPermissionGroupException, SystemException {
		PermissionGroup permissionGroup = fetchByRoleId_Last(roleId,
				orderByComparator);
	 ...
	 */
	@Override
	public PermissionGroup fetchByRoleId_Last(long roleId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<PermissionGroup> list = findByRoleId(roleId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public PermissionGroup[] findByRoleId_PrevAndNext(long permissionGroupId,
		...
		try {
			...
			array[0] = getByRoleId_PrevAndNext(session, permissionGroup,
					roleId, orderByComparator, true);

			array[1] = permissionGroup;

			array[2] = getByRoleId_PrevAndNext(session, permissionGroup,
	...
	protected PermissionGroup getByRoleId_PrevAndNext(Session session,
		PermissionGroup permissionGroup, long roleId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByRoleId(long roleId) throws SystemException {
		for (PermissionGroup permissionGroup : findByRoleId(roleId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(permissionGroup);
		}
	}
	...
	private static final String _FINDER_COLUMN_ROLEID_ROLEID_2 = "permissionGroup.roleId = ?";
	...
	public PermissionGroup updateImpl(
		...
		if (isNew || !PermissionGroupModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((permissionGroupModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						permissionGroupModelImpl.getOriginalRoleId()
					};
				...
				args = new Object[] { permissionGroupModelImpl.getRoleId() };
	...
	protected PermissionGroup toUnwrappedModel(PermissionGroup permissionGroup) {
		...
		permissionGroupImpl.setRoleId(permissionGroup.getRoleId());
