...
import com.vnpt.portlet.user.service.LiferayDatabaseLocalService;
...
/**
 * Provides the base implementation for the liferay database local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vnpt.portlet.user.service.impl.LiferayDatabaseLocalServiceImpl}.
 * </p>
 *
 * @author ToanNQ86
 ...
 * @generated
 */
public abstract class LiferayDatabaseLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LiferayDatabaseLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vnpt.portlet.user.service.LiferayDatabaseLocalServiceUtil} to access the liferay database local service.
	 */
	...
	@Override
	public LiferayDatabase addLiferayDatabase(LiferayDatabase liferayDatabase)
		throws SystemException {
		liferayDatabase.setNew(true);

		return liferayDatabasePersistence.update(liferayDatabase);
	}
	 ...
	 */
	@Override
	public LiferayDatabase createLiferayDatabase(long itemFieldId) {
		return liferayDatabasePersistence.create(itemFieldId);
	}
	...
	@Override
	public LiferayDatabase deleteLiferayDatabase(long itemFieldId)
		throws PortalException, SystemException {
		return liferayDatabasePersistence.remove(itemFieldId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LiferayDatabase deleteLiferayDatabase(
		LiferayDatabase liferayDatabase) throws SystemException {
		return liferayDatabasePersistence.remove(liferayDatabase);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LiferayDatabase.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return liferayDatabasePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return liferayDatabasePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public LiferayDatabase fetchLiferayDatabase(long itemFieldId)
		throws SystemException {
		return liferayDatabasePersistence.fetchByPrimaryKey(itemFieldId);
	}
	 ...
	 */
	@Override
	public LiferayDatabase getLiferayDatabase(long itemFieldId)
		throws PortalException, SystemException {
		return liferayDatabasePersistence.findByPrimaryKey(itemFieldId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return liferayDatabasePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LiferayDatabase> getLiferayDatabases(int start, int end)
		throws SystemException {
		return liferayDatabasePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLiferayDatabasesCount() throws SystemException {
		return liferayDatabasePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LiferayDatabase updateLiferayDatabase(
		LiferayDatabase liferayDatabase) throws SystemException {
		return liferayDatabasePersistence.update(liferayDatabase);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vnpt.portlet.user.model.LiferayDatabase",
			liferayDatabaseLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = liferayDatabasePersistence.getDataSource();
	...
	private LiferayDatabaseLocalServiceClpInvoker _clpInvoker = new LiferayDatabaseLocalServiceClpInvoker();
}