...
import com.vnpt.portlet.user.service.ActIdMembershipLocalService;
...
/**
 * Provides the base implementation for the act ID membership local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vnpt.portlet.user.service.impl.ActIdMembershipLocalServiceImpl}.
 * </p>
 *
 * @author ToanNQ86
 * @see com.vnpt.portlet.user.service.impl.ActIdMembershipLocalServiceImpl
 * @see com.vnpt.portlet.user.service.ActIdMembershipLocalServiceUtil
 * @generated
 */
public abstract class ActIdMembershipLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ActIdMembershipLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vnpt.portlet.user.service.ActIdMembershipLocalServiceUtil} to access the act ID membership local service.
	 */
	...
	@Override
	public ActIdMembership addActIdMembership(ActIdMembership actIdMembership)
		throws SystemException {
		actIdMembership.setNew(true);

		return actIdMembershipPersistence.update(actIdMembership);
	}
	 ...
	 */
	@Override
	public ActIdMembership createActIdMembership(
		ActIdMembershipPK actIdMembershipPK) {
		return actIdMembershipPersistence.create(actIdMembershipPK);
	}
	...
	@Override
	public ActIdMembership deleteActIdMembership(
		ActIdMembershipPK actIdMembershipPK)
		throws PortalException, SystemException {
		return actIdMembershipPersistence.remove(actIdMembershipPK);
	}
	...
	@Override
	public ActIdMembership deleteActIdMembership(
		ActIdMembership actIdMembership) throws SystemException {
		return actIdMembershipPersistence.remove(actIdMembership);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ActIdMembership.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return actIdMembershipPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return actIdMembershipPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ActIdMembership fetchActIdMembership(
		ActIdMembershipPK actIdMembershipPK) throws SystemException {
		return actIdMembershipPersistence.fetchByPrimaryKey(actIdMembershipPK);
	}
	 ...
	 */
	@Override
	public ActIdMembership getActIdMembership(
		ActIdMembershipPK actIdMembershipPK)
		throws PortalException, SystemException {
		return actIdMembershipPersistence.findByPrimaryKey(actIdMembershipPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return actIdMembershipPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ActIdMembership> getActIdMemberships(int start, int end)
		throws SystemException {
		return actIdMembershipPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getActIdMembershipsCount() throws SystemException {
		return actIdMembershipPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ActIdMembership updateActIdMembership(
		ActIdMembership actIdMembership) throws SystemException {
		return actIdMembershipPersistence.update(actIdMembership);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vnpt.portlet.user.model.ActIdMembership",
			actIdMembershipLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = actIdMembershipPersistence.getDataSource();
	...
	private ActIdMembershipLocalServiceClpInvoker _clpInvoker = new ActIdMembershipLocalServiceClpInvoker();
}