...
import com.vnpt.portlet.user.service.ActIdGroupLocalService;
...
/**
 * Provides the base implementation for the act ID group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vnpt.portlet.user.service.impl.ActIdGroupLocalServiceImpl}.
 * </p>
 *
 * @author ToanNQ86
 ...
 * @generated
 */
public abstract class ActIdGroupLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ActIdGroupLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vnpt.portlet.user.service.ActIdGroupLocalServiceUtil} to access the act ID group local service.
	 */
	...
	@Override
	public ActIdGroup addActIdGroup(ActIdGroup actIdGroup)
		throws SystemException {
		actIdGroup.setNew(true);

		return actIdGroupPersistence.update(actIdGroup);
	}
	 ...
	 */
	@Override
	public ActIdGroup createActIdGroup(String id) {
		return actIdGroupPersistence.create(id);
	}
	...
	@Override
	public ActIdGroup deleteActIdGroup(String id)
		throws PortalException, SystemException {
		return actIdGroupPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ActIdGroup deleteActIdGroup(ActIdGroup actIdGroup)
		throws SystemException {
		return actIdGroupPersistence.remove(actIdGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ActIdGroup.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return actIdGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return actIdGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return actIdGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ActIdGroup fetchActIdGroup(String id) throws SystemException {
		return actIdGroupPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public ActIdGroup getActIdGroup(String id)
		throws PortalException, SystemException {
		return actIdGroupPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return actIdGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ActIdGroup> getActIdGroups(int start, int end)
		throws SystemException {
		return actIdGroupPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getActIdGroupsCount() throws SystemException {
		return actIdGroupPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ActIdGroup updateActIdGroup(ActIdGroup actIdGroup)
		throws SystemException {
		return actIdGroupPersistence.update(actIdGroup);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vnpt.portlet.user.model.ActIdGroup",
			actIdGroupLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = actIdGroupPersistence.getDataSource();
	...
	private ActIdGroupLocalServiceClpInvoker _clpInvoker = new ActIdGroupLocalServiceClpInvoker();
}