...
import com.vnpt.portlet.user.service.GroupUsersLocalService;
...
/**
 * Provides the base implementation for the group users local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vnpt.portlet.user.service.impl.GroupUsersLocalServiceImpl}.
 * </p>
 *
 * @author ToanNQ86
 ...
 * @generated
 */
public abstract class GroupUsersLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GroupUsersLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vnpt.portlet.user.service.GroupUsersLocalServiceUtil} to access the group users local service.
	 */
	...
	@Override
	public GroupUsers addGroupUsers(GroupUsers groupUsers)
		throws SystemException {
		groupUsers.setNew(true);

		return groupUsersPersistence.update(groupUsers);
	}
	 ...
	 */
	@Override
	public GroupUsers createGroupUsers(GroupUsersPK groupUsersPK) {
		return groupUsersPersistence.create(groupUsersPK);
	}
	...
	@Override
	public GroupUsers deleteGroupUsers(GroupUsersPK groupUsersPK)
		throws PortalException, SystemException {
		return groupUsersPersistence.remove(groupUsersPK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GroupUsers deleteGroupUsers(GroupUsers groupUsers)
		throws SystemException {
		return groupUsersPersistence.remove(groupUsers);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GroupUsers.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return groupUsersPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return groupUsersPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return groupUsersPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GroupUsers fetchGroupUsers(GroupUsersPK groupUsersPK)
		throws SystemException {
		return groupUsersPersistence.fetchByPrimaryKey(groupUsersPK);
	}
	 ...
	 */
	@Override
	public GroupUsers getGroupUsers(GroupUsersPK groupUsersPK)
		throws PortalException, SystemException {
		return groupUsersPersistence.findByPrimaryKey(groupUsersPK);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return groupUsersPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GroupUsers> getGroupUserses(int start, int end)
		throws SystemException {
		return groupUsersPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGroupUsersesCount() throws SystemException {
		return groupUsersPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GroupUsers updateGroupUsers(GroupUsers groupUsers)
		throws SystemException {
		return groupUsersPersistence.update(groupUsers);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vnpt.portlet.user.model.GroupUsers",
			groupUsersLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = groupUsersPersistence.getDataSource();
	...
	private GroupUsersLocalServiceClpInvoker _clpInvoker = new GroupUsersLocalServiceClpInvoker();
}