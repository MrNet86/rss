...
/**
 * Provides the local service interface for GroupRoles. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ToanNQ86
 * @see GroupRolesLocalServiceUtil
...
public interface GroupRolesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GroupRolesLocalServiceUtil} to access the group roles local service. Add custom service methods to {@link com.vnpt.portlet.user.service.impl.GroupRolesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
