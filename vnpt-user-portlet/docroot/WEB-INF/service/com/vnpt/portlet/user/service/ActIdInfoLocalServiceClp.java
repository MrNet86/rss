 ...
 * @generated
 */
public class ActIdInfoLocalServiceClp implements ActIdInfoLocalService {
	public ActIdInfoLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public com.vnpt.portlet.user.model.ActIdInfo addActIdInfo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(actIdInfo) });
		}
		catch (Throwable t) {
		...
		return (com.vnpt.portlet.user.model.ActIdInfo)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.vnpt.portlet.user.model.ActIdInfo> getActIdInfos(
		...
		return (java.util.List<com.vnpt.portlet.user.model.ActIdInfo>)ClpSerializer.translateOutput(returnObj);
	}
