...
/**
 * The persistence utility for the act ID info service. This utility wraps {@link ActIdInfoPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ActIdInfoPersistenceImpl
 * @generated
 */
public class ActIdInfoUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ActIdInfo actIdInfo) {
		getPersistence().clearCache(actIdInfo);
	}
	 ...
	 */
	public static List<ActIdInfo> findWithDynamicQuery(
	 ...
	 */
	public static ActIdInfo update(ActIdInfo actIdInfo)
		throws SystemException {
		return getPersistence().update(actIdInfo);
	}
	...
	public static ActIdInfo update(ActIdInfo actIdInfo,
		...
		return getPersistence().update(actIdInfo, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(actIdInfo);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<com.vnpt.portlet.user.model.ActIdInfo> actIdInfos) {
		getPersistence().cacheResult(actIdInfos);
	}
	...
	*/
	public static com.vnpt.portlet.user.model.ActIdInfo create(long id) {
	...
	*/
	public static com.vnpt.portlet.user.model.ActIdInfo remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.vnpt.portlet.user.NoSuchActIdInfoException {
		return getPersistence().remove(id);
	}

	public static com.vnpt.portlet.user.model.ActIdInfo updateImpl(
		com.vnpt.portlet.user.model.ActIdInfo actIdInfo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(actIdInfo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vnpt.portlet.user.model.ActIdInfo findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.vnpt.portlet.user.NoSuchActIdInfoException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vnpt.portlet.user.model.ActIdInfo fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.vnpt.portlet.user.model.ActIdInfo> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ActIdInfoPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ActIdInfoPersistence)PortletBeanLocatorUtil.locate(com.vnpt.portlet.user.service.ClpSerializer.getServletContextName(),
					ActIdInfoPersistence.class.getName());

			ReferenceRegistry.registerReference(ActIdInfoUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ActIdInfoPersistence persistence) {
	}

	private static ActIdInfoPersistence _persistence;
}