...
/**
 * Provides the local service utility for GroupRoles. This utility wraps
 * {@link com.vnpt.portlet.user.service.impl.GroupRolesLocalServiceImpl} and is the
 ...
 * @generated
 */
public class GroupRolesLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.vnpt.portlet.user.service.impl.GroupRolesLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.vnpt.portlet.user.model.GroupRoles addGroupRoles(
		com.vnpt.portlet.user.model.GroupRoles groupRoles)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addGroupRoles(groupRoles);
	}
	...
	*/
	public static com.vnpt.portlet.user.model.GroupRoles createGroupRoles(
		com.vnpt.portlet.user.service.persistence.GroupRolesPK groupRolesPK) {
		return getService().createGroupRoles(groupRolesPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vnpt.portlet.user.model.GroupRoles deleteGroupRoles(
		com.vnpt.portlet.user.service.persistence.GroupRolesPK groupRolesPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteGroupRoles(groupRolesPK);
	}
	...
	*/
	public static com.vnpt.portlet.user.model.GroupRoles deleteGroupRoles(
		com.vnpt.portlet.user.model.GroupRoles groupRoles)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteGroupRoles(groupRoles);
	}
	...
	*/
	...
	public static com.vnpt.portlet.user.model.GroupRoles fetchGroupRoles(
		com.vnpt.portlet.user.service.persistence.GroupRolesPK groupRolesPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchGroupRoles(groupRolesPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vnpt.portlet.user.model.GroupRoles getGroupRoles(
		com.vnpt.portlet.user.service.persistence.GroupRolesPK groupRolesPK)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getGroupRoles(groupRolesPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.vnpt.portlet.user.model.GroupRoles> getGroupRoleses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getGroupRoleses(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getGroupRolesesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getGroupRolesesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vnpt.portlet.user.model.GroupRoles updateGroupRoles(
		com.vnpt.portlet.user.model.GroupRoles groupRoles)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateGroupRoles(groupRoles);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.portal.model.Role> getRolesByPerGroupId(
	...
	public static GroupRolesLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					GroupRolesLocalService.class.getName());

			if (invokableLocalService instanceof GroupRolesLocalService) {
				_service = (GroupRolesLocalService)invokableLocalService;
			}
			else {
				_service = new GroupRolesLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(GroupRolesLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(GroupRolesLocalService service) {
	}

	private static GroupRolesLocalService _service;
}