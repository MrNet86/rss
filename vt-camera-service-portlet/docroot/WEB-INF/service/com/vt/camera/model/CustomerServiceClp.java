...
import com.vt.camera.service.ClpSerializer;
...
public class CustomerServiceClp extends BaseModelImpl<CustomerService>
	...
	public void setLine(String line) {
		...
		if (_customerServiceRemoteModel != null) {
			try {
				...
				method.invoke(_customerServiceRemoteModel, line);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public String toXmlString() {
		...
		sb.append("com.vt.camera.model.CustomerService");
	...
	private Class<?> _clpSerializerClass = com.vt.camera.service.ClpSerializer.class;
}