...
public class CustomerWrapper implements Customer, ModelWrapper<Customer> {
	...
	*/
	...
	@Override
	public int compareTo(com.vt.camera.model.Customer customer) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.vt.camera.model.Customer> toCacheModel() {
		return _customer.toCacheModel();
	}

	@Override
	public com.vt.camera.model.Customer toEscapedModel() {
		return new CustomerWrapper(_customer.toEscapedModel());
	}

	@Override
	public com.vt.camera.model.Customer toUnescapedModel() {
