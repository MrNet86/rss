...
import com.vt.camera.NoSuchCustomerServiceException;
import com.vt.camera.model.CustomerService;
import com.vt.camera.model.impl.CustomerServiceImpl;
import com.vt.camera.model.impl.CustomerServiceModelImpl;
...
public class CustomerServicePersistenceImpl extends BasePersistenceImpl<CustomerService>
	...
	protected CustomerService toUnwrappedModel(CustomerService customerService) {
		...
		customerServiceImpl.setLine(customerService.getLine());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.vt.camera.model.CustomerService")));
