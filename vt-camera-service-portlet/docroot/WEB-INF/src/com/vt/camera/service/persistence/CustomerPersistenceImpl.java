...
import com.vt.camera.NoSuchCustomerException;
import com.vt.camera.model.Customer;
import com.vt.camera.model.impl.CustomerImpl;
import com.vt.camera.model.impl.CustomerModelImpl;
...
public class CustomerPersistenceImpl extends BasePersistenceImpl<Customer>
	...
	@Override
	public Customer updateImpl(com.vt.camera.model.Customer customer)
		throws SystemException {
		customer = toUnwrappedModel(customer);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.vt.camera.model.Customer")));
